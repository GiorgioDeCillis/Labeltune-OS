...
function renderComponent(
    ...
    if (component.type === 'Labels' || component.type === 'RectangleLabels' || component.type === 'PolygonLabels') return <ImageLabelsControl key={component.id} component={component} value={value} onChange={onChange} readOnly={isReadOnly} data={taskDataSafe} />;
