    ...
    return (
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
            <div className="flex items-center justify-between">
                <div>
                    <h1 className="text-3xl font-black tracking-tight text-white">Knowledge Base</h1>
                ...
                <div className="flex gap-3">
                    <Link href="/dashboard/knowledge/courses/new">
                        <button className="px-6 py-2.5 bg-primary/20 text-primary font-black rounded-xl hover:bg-primary/30 transition-all shadow-lg flex items-center gap-2 border border-primary/30">
